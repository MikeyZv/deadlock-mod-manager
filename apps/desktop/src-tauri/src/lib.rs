...
pub fn run() {
  ...
  builder
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::config_mods::get_mod_config_info,
      commands::config_mods::install_config_mod,
      commands::config_mods::uninstall_config_mod,
      commands::config_mods::stage_config_mod_variant,
      commands::config_mods::scan_and_stash_local_mod_config,
